...
See [ast-types-yx](https://github.com/benjamn/ast-types-yx) (especially the [def/core.ts](https://github.com/benjamn/ast-types-yx/blob/master/def/core.ts)) module for a thorough overview of the `ast` API.
```js
