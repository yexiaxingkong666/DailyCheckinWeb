...
<head>
    <title>Code coverage report for gogocode-core/src/html-core/get-selector.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/html-core</a> get-selector.js</h1>
        <div class='clearfix'>
...
&nbsp;
function getSelector(selectorCode, parseOptions, expando = <span class="branch-0 cbranch-no" title="branch not covered" >'g123o456g789o')</span> {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (selectorAst.content &amp;&amp; selectorAst.content.children &amp;&amp; selectorAst.content.children[0]) {
