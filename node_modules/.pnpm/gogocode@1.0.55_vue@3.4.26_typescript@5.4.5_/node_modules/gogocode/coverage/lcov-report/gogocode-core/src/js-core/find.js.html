...
<head>
    <title>Code coverage report for gogocode-core/src/js-core/find.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/js-core</a> find.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">89.74% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>105/117</span>
            </div>
...
<a name='L222'></a><a href='#L222'>222</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">33x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2887x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4497x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">172x</span>
<span class="cline-any cline-yes">4325x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2181x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">33x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { isObject, hasOwn } = require('../util')
// 通过简单ast结构查找ast节点
&nbsp;
    ...
    return Object.keys(partial).every((prop) =&gt; {
        if (prop == 'body') {
            ...
            try {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (bodyContent &amp;&amp; bodyContent.expression.name &amp;&amp; bodyContent.expression.name.match) {
        ...
        if (!full || !partial) {
            ...
            if (Array.isArray(partial[prop]) &amp;&amp; !strictSequence) {
                ...
                try {
                    ...
                    if (!fullProp) {
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (partial[prop] &amp;&amp; partial[prop].name &amp;&amp; partial[prop].name.match(Expando)) {
<span class="cstat-no" title="statement not covered" >                            fullProp = full;</span>
                        }
                    }
                    res =
                        // hasOwn(full, prop) 
...
<span class="cstat-no" title="statement not covered" >                    console.log(e);</span>
            ...
            if (partial[prop].match &amp;&amp; partial[prop].match(Expando)) {
                ...
                case 'Identifier':
                    ...
                    break;
<span class="branch-1 cbranch-no" title="branch not covered" >                case 'ThisExpression':</span>
<span class="cstat-no" title="statement not covered" >                    extra.value = 'this';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
                ...
                case 'BooleanLiteral':
                    extra.value = full.value;
                    break;
<span class="branch-5 cbranch-no" title="branch not covered" >                case 'NullLiteral':</span>
<span class="cstat-no" title="statement not covered" >                    extra.value = null;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
                default:
                    try {
                        extra.value = generate(full);
                    } catch(e) {
<span class="cstat-no" title="statement not covered" >                        if (full[prop]) {</span>
<span class="cstat-no" title="statement not covered" >                            extra.value = full[prop];</span>
                        } else {
...
function find$$$(partial, full, extraData, strictSequence) {
    ...
    partial.forEach((p, i) =&gt; {
        for (const key in p) {
            const value = p[key] ? (p[key].name || p[key].value || p[key]) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
            if (value &amp;&amp; value.match &amp;&amp; value.match(new RegExp(Expando.slice(0, -1) + '\\$3'))) {
                key$$$ = value.replace(new RegExp(Expando.slice(0, -1) + '\\$3'), '') || <span class="branch-1 cbranch-no" title="branch not covered" >'$'</span>
                index$$$ = i;
                // partial.splice(i, 1);
                // // 存疑🤨
                break;
...
function find(nodeType, structure, strictSequence, deep = 'nn', expando = <span class="branch-0 cbranch-no" title="branch not covered" >'g123o456g789o')</span> {
    const nodePathList = [];
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Feb 26 2022 18:08:43 GMT+0800 (中国标准时间)
            </div>
        </div>
