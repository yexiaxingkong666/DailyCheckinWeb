...
<head>
    <title>Code coverage report for gogocode-core/src/js-core/core.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/js-core</a> core.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">83.09% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>236/284</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>188/240</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>234/280</span>
            </div>
...
<a name='L500'></a><a href='#L500'>500</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">37x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">37x</span></td><td class="text"><pre class="prettyprint lang-js">const getSelector = require('./get-selector');
...
const core = {
    ...
    getAstsBySelector(ast, selector, { strictSequence, deep, parseOptions, expando = 'g123o456g789o' } = {}) { 
        ...
        selector.forEach(item =&gt; {
            ...
            sels.forEach(sel =&gt; {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!sel.nodeType) {
<span class="cstat-no" title="statement not covered" >                    throw new Error('语句类型缺失，请在 https://github.com/thx/gogocode/issues 上提供您的代码样例')</span>
                }
...
<span class="cstat-no" title="statement not covered" >            path = parent;</span>
<span class="cstat-no" title="statement not covered" >            parent = parent.parentPath;</span>
        }
        parent = parent.value;
...
<span class="cstat-no" title="statement not covered" >        return null;</span>
    ...
    hasChildrenSelector(path, childSelector, expando) {
        const childCache = path.__childCache || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
<span class="cstat-no" title="statement not covered" >                    return null;</span>
    ...
    replaceStrByAst(ast, astPatialMap = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    ...
    replaceAstByAst(oldAst, newAst) {
        if (Array.isArray(newAst)) {
            const { arrPath = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> index } = getArrPath(oldAst);
            <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(arrPath.value) &amp;&amp; index &gt; -1) {
                arrPath.value.splice(index, 1, ...newAst);
                return;
            }
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (newAst.type == 'BlockStatement' &amp;&amp; Array.isArray(oldAst.parentPath.value)) {
            const parentNode = <span class="cstat-no" title="statement not covered" >oldAst.parentPath.value;</span>
            const oldIndex = <span class="cstat-no" title="statement not covered" >parentNode.indexOf(oldAst.node);</span>
<span class="cstat-no" title="statement not covered" >            parentNode.splice(oldIndex, 1);</span>
<span class="cstat-no" title="statement not covered" >            newAst.body.forEach(<span class="fstat-no" title="function not covered" >(r</span>eplacer, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                oldAst.parentPath.value.splice(oldIndex + index, 0, replacer)</span>
            })
...
&nbsp;
                            ...
                            let wildCardCode = extra[key].map(item =&gt; 
                                typeof item.value !== 'object' ? (item.raw || item.value) : <span class="branch-1 cbranch-no" title="branch not covered" >``</span>
                            ).join(', ')
&nbsp;
                            let wildCardCodeNoQuot = extra[key].map(item =&gt; 
                                typeof item.value !== 'object' ? (item.value) : <span class="branch-1 cbranch-no" title="branch not covered" >``</span>
                            ).join(', ')
&nbsp;
                            newReplacer = newReplacer
                ...
                if (!replacer) {
                    ...
                    if (buildMap[path.node.type]) {
                        try {
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (buildMap[path.node.type](newReplacer)) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!replacerAst) {
<span class="cstat-no" title="statement not covered" >                        throw new Error(`replace failed: ${newReplacer} cannot be parsed!`)</span>
                    }
                ...
                if (!replacer) {
                    ...
                    let replacerAst = replacer.type ? <span class="branch-0 cbranch-no" title="branch not covered" >replacer </span>: core.buildAstByAstStr(replacer, { }, { parseOptions });
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!replacer.type &amp;&amp; buildMap[path.node.type]) {
<span class="cstat-no" title="statement not covered" >                        try {</span>
<span class="cstat-no" title="statement not covered" >                            if (buildMap[path.node.type](replacer)) {</span>
<span class="cstat-no" title="statement not covered" >                                replacerAst = buildMap[path.node.type](replacer)</span>
                            }
                        } catch(e) {
                            //
                        }
...
<span class="cstat-no" title="statement not covered" >                    if (replacer[0] &amp;&amp; replacer[0].nodePath) {</span>
<span class="cstat-no" title="statement not covered" >                        path.replace(replacer[0].nodePath.node)</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        core.replaceAstByAst(path, replacer);</span>
                    }
                }
            }
        });
    ...
    insertAstListBefore(path, nodeList) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!Array.isArray(nodeList)) {
            nodeList = [nodeList]
        }
        for (let i = 0; i&lt; 3; i++) {
...
<span class="cstat-no" title="statement not covered" >                path = pNode;</span>
            }
        }
    },
...
<span class="cstat-no" title="statement not covered" >                path = pNode;</span>
    ...
    removeAst(ast, selector, { strictSequence, parseOptions, expando } = {}) {
        ...
        if (!selector || (typeof selector !== 'object' &amp;&amp; typeof selector !== 'string' &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >!Array.isArray(selector))</span>) {
    ...
    appendJsxAttr(ast, obj) {
        ...
        try {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (ast.value) {
<span class="cstat-no" title="statement not covered" >                ast.value.openingElement.attributes = ast.value.openingElement.attributes.concat(newAttrs);</span>
            } else {
                ast.expression.openingElement.attributes = ast.expression.openingElement.attributes.concat(newAttrs);
            }
            
        } catch(e) {
<span class="cstat-no" title="statement not covered" >            throw new Error('appendJsxAttr failed!' + e)</span>
        }
    ...
    traverse(node, cb, parentNode) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (node.type &amp;&amp; typeof node.type == 'string') {
            // 是一个ast节点,且不是token
            <span class="missing-if-branch" title="else path not taken" >E</span>if (['File', 'Program'].indexOf(node.type) == -1) {
                cb(node, { parentNode });
            }
...
<span class="fstat-no" title="function not covered" >    in</span>itComment(ast) {
<span class="cstat-no" title="statement not covered" >        core.traverse(ast, (<span class="fstat-no" title="function not covered" >(n</span>ode, {parentNode}) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >                if (index == parentNode.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >                    if (node.trailingComments) {</span>
<span class="cstat-no" title="statement not covered" >                        node.trailingComments.forEach(<span class="fstat-no" title="function not covered" >co</span>mment =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                            parentNode.push(comment);</span>
                        })
                    }
                }
<span class="cstat-no" title="statement not covered" >                if (node.leadingComments) {</span>
<span class="cstat-no" title="statement not covered" >                    node.leadingComments.reverse().forEach(<span class="fstat-no" title="function not covered" >co</span>mment =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        parentNode.splice(index, 0, comment);</span>
                    })
                }
            }
        }))
    },
<span class="fstat-no" title="function not covered" >    re</span>moveComments(ast) {
<span class="cstat-no" title="statement not covered" >        core.traverse(ast, (<span class="fstat-no" title="function not covered" >(n</span>ode, {parentNode}) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (Array.isArray(parentNode)) {</span>
<span class="cstat-no" title="statement not covered" >                if (!parentNode.every(<span class="fstat-no" title="function not covered" >it</span>em =&gt; <span class="cstat-no" title="statement not covered" >typeof item.type == 'string' &amp;&amp; item.type.match('Comment'))</span>) {</span>
                    let i = <span class="cstat-no" title="statement not covered" >0;</span>
<span class="cstat-no" title="statement not covered" >                    while (parentNode[i]) {</span>
                        const node = <span class="cstat-no" title="statement not covered" >parentNode[i];</span>
<span class="cstat-no" title="statement not covered" >                        if (node &amp;&amp; typeof node.type == 'string' &amp;&amp; node.type.match('Comment')) {</span>
<span class="cstat-no" title="statement not covered" >                            parentNode.splice(i, 1);</span>
...
function getArrPath(path) {
    let arrPath = path
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!arrPath) <span class="cstat-no" title="statement not covered" >return;</span>
...
<span class="cstat-no" title="statement not covered" >        return { arrPath: {}, index: -1 };</span>
    }
}
module.exports = core;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Jul 22 2022 17:54:17 GMT+0800 (中国标准时间)
            </div>
