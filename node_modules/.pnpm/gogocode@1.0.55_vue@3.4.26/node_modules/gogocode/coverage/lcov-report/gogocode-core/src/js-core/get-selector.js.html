...
<head>
    <title>Code coverage report for gogocode-core/src/js-core/get-selector.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/js-core</a> get-selector.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">37x</span></td><td class="text"><pre class="prettyprint lang-js">// 把简单的api转换成ast
// todo await 
        ...
        if (seletorAst.program.body.length == 0) {
            ...
            if (seletorAst.program.directives.length) {
                return {
                    ...
                    structure: {
                        value: selectorCode ? selectorCode.slice(1, -1) : <span class="branch-1 cbranch-no" title="branch not covered" >''</span>
                    }
                }
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (seletorAst.program.comments.length) {
...
<span class="cstat-no" title="statement not covered" >            seletorAst = null;</span>
        }
...
<span class="cstat-no" title="statement not covered" >            throw new Error('parse error!' + e.message);</span>
        }
    }
    visit(seletorAst, {
        visitExpressionStatement(path) {
            const expression = path.value.expression;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!expression) <span class="cstat-no" title="statement not covered" >return;</span>
        ...
        visitDeclaration(path) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!declaration) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
&nbsp;
module.exports = getSelector;</pre></td></tr></table></pre>
