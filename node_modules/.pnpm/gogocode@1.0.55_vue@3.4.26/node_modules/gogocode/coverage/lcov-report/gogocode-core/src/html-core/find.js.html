...
<head>
    <title>Code coverage report for gogocode-core/src/html-core/find.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/html-core</a> find.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>116/128</span>
            </div>
...
<a name='L227'></a><a href='#L227'>227</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">37x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1969x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">37x</span></td><td class="text"><pre class="prettyprint lang-js">const { isObject, hasOwn, escapeRegExp } = require('../util')
// 通过简单ast结构查找ast节点
...
function checkIsMatch(full, partial, extraData, strictSequence) {
    return Object.keys(partial).every(prop =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!full || !partial) {
            ...
            if (Array.isArray(partial[prop]) &amp;&amp; !strictSequence) {
                if (hasOwn(full, prop)) {
                    res = partial[prop].every(p =&gt; {
                        let a = false;
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (!full[prop].length &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >partial[prop].length == 1 </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >has$$$)</span> {
<span class="cstat-no" title="statement not covered" >                            return true</span>
                ...
                // todo
                try {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (partial[prop].type == 'token:attribute-value' &amp;&amp; !full[prop]) {
<span class="cstat-no" title="statement not covered" >                        if (partial[prop].content.match &amp;&amp; partial[prop].content.match(Expando)) {</span>
                            const expandoKey = <span class="cstat-no" title="statement not covered" >partial[prop].content.replace(Expando, '') || '0';</span>
<span class="cstat-no" title="statement not covered" >                            extraData[expandoKey] = extraData[expandoKey] || [];</span>
<span class="cstat-no" title="statement not covered" >                            extraData[expandoKey].push({ node: null, value: null })</span>
<span class="cstat-no" title="statement not covered" >                            return true;</span>
                        }
                    }
...
&nbsp;
            ...
            if (partial[prop] == Expando || (partial[prop].match &amp;&amp; partial[prop].match(Expando))) {
                ...
                extraData[expandoKey] = extraData[expandoKey] || [];
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!full) <span class="cstat-no" title="statement not covered" >return;</span>
                if (full[prop] !== undefined) {
                    extra.value = full[prop] || '';
                } else <span class="missing-if-branch" title="else path not taken" >E</span>{
<span class="cstat-no" title="statement not covered" >                    extra.value = {};</span>
<span class="cstat-no" title="statement not covered" >                    filterProps(full, extra.value);</span>
                }
                extraData[expandoKey].push(extra);
                return true;
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (partial[prop]) {
                // const reg = /^(?:\$\[).*(?=\]\$)/;
            }
            if (prop == 'content') {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (partial[prop].trim().match(new RegExp(Expando))) {
<span class="cstat-no" title="statement not covered" >                    return true; </span>
                } else {
                    if (partial.type == 'token:attribute-key') {
                        return full ? full[prop] == partial[prop].trim() : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
                    }
                    return full ? !!full[prop].match(escapeRegExp(partial[prop].trim())) : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
                }
            } else {
                return full ? full[prop] == partial[prop] : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
            }
        }
    });
}
...
&nbsp;
function find(nodeType, structure, strictSequence, deep, expando = <span class="branch-0 cbranch-no" title="branch not covered" >'g123o456g789o')</span> {
    const nodePathList = [];
    ...
    const traverseMap = {
        tag: (nodeType == 'tag' || nodeType == 'script') ? [{
            ...
            handle(tagContent, { attrMap, parentRef, nodeRef } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        ...
        attr: [],
        text: nodeType == 'text' ? [{
            value: [(structure.content.trim &amp;&amp; structure.content.trim() == Expando || <span class="branch-2 cbranch-no" title="branch not covered" >structure.content.value.content.trim() == Expando)</span> ? '' : <span class="branch-1 cbranch-no" title="branch not covered" >structure.content.value.content.trim()]</span>,
            type: 'containOne',
            handle(node) {
...
&nbsp;
module.exports = { find };</pre></td></tr></table></pre>
