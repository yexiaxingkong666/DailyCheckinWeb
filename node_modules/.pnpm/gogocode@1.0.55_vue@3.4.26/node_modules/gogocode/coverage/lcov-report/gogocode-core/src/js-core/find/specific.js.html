...
<head>
    <title>Code coverage report for gogocode-core/src/js-core/find/specific.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">gogocode-core/src/js-core/find</a> specific.js</h1>
        <div class='clearfix'>
...
<a name='L51'></a><a href='#L51'>51</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">37x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6245x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const generate = require('../generate')
module.exports = function handleSpecific({ full, partial, prop, extraData, Expando, find$$$ } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    let specific, result;
    if (prop == 'body') {
        // 匹配一块代码
        try {
            ...
            if (name &amp;&amp; name.match) {
                if (name.match(Expando)) {
                    ...
                    // 去掉首尾花括号
                    let bodyStr = generate(full.body) || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
                    if (bodyStr.trim()[0] == '{') {
    ...
    if (partial &amp;&amp; partial.typeName &amp;&amp; !partial.typeParameters) {
        if (partial.typeName.name.match(Expando)) {
            ...
            const expandoKey = partial.typeName.name.replace(Expando, '') || <span class="branch-1 cbranch-no" title="branch not covered" >'0';</span>
            extraData[expandoKey] = extraData[expandoKey] || [];
