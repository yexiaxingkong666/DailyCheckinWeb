...
<head>
    <title>Code coverage report for gogocode-core/src/Ast.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">gogocode-core/src</a> Ast.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.01% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>458/477</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>311/344</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>455/472</span>
            </div>
...
<a name='L841'></a><a href='#L841'>841</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">36x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1705x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">343x</span>
<span class="cline-any cline-yes">2160x</span>
<span class="cline-any cline-yes">343x</span>
...
<span class="cline-any cline-yes">1783x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">36x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const generate = require('./js-core/generate');
...
&nbsp;
class AST {
    constructor(nodePath, { parseOptions, match, rootNode } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        if (nodePath) {
            this[0] = {
                nodePath, match
            }
    ...
    get node() {
        return this[0] ? this[0].nodePath.node : <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
    }
    get value() {
        return this[0] ? this[0].nodePath.value : <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
    }
    get match() {
    ...
    each(callback) {
        ...
        while (this[i]) {
            ...
            callback(eachNode, i);
            newAST[i] = eachNode[0] || <span class="branch-1 cbranch-no" title="branch not covered" >null</span>
            i++;
        }
        return newAST
    }
    find(selector, options = {}) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this[0]) {
...
&nbsp;
        ...
        function parentMatch (full, partial) {
            return Object.keys(partial).every(prop =&gt; {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!full[prop]) <span class="cstat-no" title="statement not covered" >return false;</span>
                <span class="missing-if-branch" title="if path not taken" >I</span>if (isObject(partial[prop])) {
<span class="cstat-no" title="statement not covered" >                    return parentMatch(full[prop], partial[prop])</span>
                } else {
...
&nbsp;
    ...
    root(option) {
        ...
        if (this.parseOptions &amp;&amp; this.parseOptions.rootLanguage == 'vue') {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (option == 'template') {
<span class="cstat-no" title="statement not covered" >                newAST[0] = { nodePath: this.rootNode.node.templateAst }</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (option == 'script') {
<span class="cstat-no" title="statement not covered" >                newAST[0] = { nodePath: this.rootNode.node.scriptAst }</span>
            } else {
...
&nbsp;
    ...
    attr(arg1, arg2) {
        ...
        if (arg2) {
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof arg1 == 'object') {
                attrMap = arg1;
            }
        }
    ...
    child(attrName) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this[0] || !this[0].nodePath || !this[0].nodePath.node) {
<span class="cstat-no" title="statement not covered" >            return this;</span>
        }
...
<span class="cstat-no" title="statement not covered" >                    newNodeAST = cloneAST(this);</span>
<span class="cstat-no" title="statement not covered" >                    parentPath = nodePath</span>
<span class="cstat-no" title="statement not covered" >                    nodePath = new NodePath(currentNode[attr], nodePath, nodePath)</span>
<span class="cstat-no" title="statement not covered" >                    newNodeAST[0] = { nodePath, parseOptions: this.parseOptions }</span>
                }
                currentNode = node
                deep++
            }
...
&nbsp;
        ...
        if (this.isHtml) {
            ...
            if (this.node.nodeType == 'document') {
                ...
                // todotodo
                p = parent.attr('content.children') || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
                p.forEach((item, i) =&gt; {
                    if (item == this.node) {
                        index = i
                    }
            ...
            while(!getArrayParent) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!parentList[i] || !parentList[i].value) {
<span class="cstat-no" title="statement not covered" >                    getArrayParent = true;</span>
                } else if (Array.isArray(parentList[i].value)) {
                    getArrayParent = true;
                    parentList[i].value.forEach((nodePath, index) =&gt; {
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (nodePath == selfPathNode) {
                            selfIndex = index;
                        }
                    })
                    if (type == 'after') {
...
<span class="cstat-no" title="statement not covered" >                        parentList[i].value.splice(selfIndex, 0, node)</span>
                    }
                }
...
<span class="cstat-no" title="statement not covered" >                return this;</span>
    ...
    insertChildNode(attr, node, type) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!Array.isArray(selfNode)) {
            ...
            if (attr == 'content.children') {
                selfNode.content.children = selfNode.content.children || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (selfNode) {
            if (type == 'append') {
                selfNode.push(node);
            } else {
    ...
    empty() {
        this.each(item =&gt; {
            if (item.language == 'html') {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(item.attr('content.children'))) {
                    item.attr('content.children', []);
                }
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (item.language == 'js') {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(item[0].nodePath.value)) {
<span class="cstat-no" title="statement not covered" >                    item[0].nodePath.value = [];</span>
...
function cloneAST(ast) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ast.sfc) {
<span class="cstat-no" title="statement not covered" >        newAST.sfc = ast.sfc</span>
    }
    return newAST
}
&nbsp;
...
function initSiblings(ast) {
    if (ast.language == 'html') {
        ...
        const siblings = (parent.attr('content.children') || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.map((node, index) =&gt; {
            return {
                _index: index,
...
function setAttrValue(node, attrMap) {
    for(const key in attrMap) {
        ...
        keyList.forEach((attr, index) =&gt; {
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (currentNode[attr]) {
                currentNode = currentNode[attr]
            }
        })
    }
